  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        color: { value: new THREE.Color("#ffffff") }, // White color
      },
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full text-center">
        <div className="max-w-2xl px-4 animate-fade-in-long">
          <h1 className="text-xs font-sans tracking-widest text-gray-300 uppercase mb-6">
            {title}
          </h1>
          <p className="text-3xl md:text-5xl font-bold leading-tight text-white mb-8" style={{ fontFamily: 'ui-sans-serif, system-ui, sans-serif' }}>
            {subtitle}
          </p>
