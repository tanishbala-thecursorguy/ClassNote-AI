...
export const LoginWorkflow = ({ onComplete }: LoginWorkflowProps) => {
  ...
  const [isRoleBasedLogin, setIsRoleBasedLogin] = useState(false);
  ...
  const handleStudentLogin = async () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      onComplete(); // Complete the login flow
    }, 1000);
  };
  ...
  return (
    <div ref={containerRef} className="login-workflow-container">
